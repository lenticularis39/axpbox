...
private:
  struct CThreadData : public CRefCountedObject {
    CThreadData()
        : pTarget(0), thread(0), prio(PRIO_NORMAL_IMPL), done(false) {}
...
// inlines
//
inline int CThreadImpl::getPriorityImpl() const { return _pData->prio; }
...
inline void CThreadImpl::yieldImpl() { sched_yield(); }
